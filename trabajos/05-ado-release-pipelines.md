...
4.1.1\. Navigate to [https://azure.microsoft.com/es-mx/](https://azure.microsoft.com/es-mx/)


4.1.2\. Click "Comenzar a usar Azure"
...
4.1.3\. Click "Probar Azure gratis"
...
4.1.12\. Click "To verify your email address use this security code: 399365"
...
4.1.16\. Click "Acepto el contrato de cliente."
...
4.1.17\. Click the "Teléfono" field.
...
4.1.18\. Click "Envíeme un mensaje de texto"
...
4.1.21\. Click this button field.
...
4.1.25\. Click "Regístrese para obtener Azure con los precios de pago por uso."
...
4.1.26\. Click "Acepto el contrato de cliente."
...
4.1.34\. Click "[azportal2024@gmail.com](mailto:azportal2024@gmail.com)"
...
#### 4.2 Crear un recurso Web App en Azure Portal

4.2.1\. Navegar to [https://portal.azure.com/#home](https://portal.azure.com/#home)


4.2.2\. Click en este icono.
...
4.2.3\. Click en "Buscar servicios y marketplace" .
...
4.2.6\. Click "Información de uso y soporte técnico"
...
4.2.8\. Click "(Nuevo) Grupo de recursos"
...
4.2.9\. Click "(Nuevo) Grupo de recursos"
...
4.2.11\. Type "TPSIngSoft3UCC2024"
...
4.2.16\. Click "Seleccione una pila del entorno en tiempo de ejecución"
...
4.2.18\. Click "Estándar S1 (Total de ACU: 100, 1.75 GB de memoria, 1 vCPU)"
...
4.2.19\. Click "60 minutos de CPU/día incluidos"
...
4.2.21\. Type "MiAppPlan01"


4.2.22\. Click "Aceptar"
...
4.2.23\. Click "Siguiente: Base de datos >"
...
4.2.24\. Click "Siguiente: Implementación >"
...
4.2.27\. Click "Siguiente: Supervisión y protección >"
...
4.2.29\. Click "Siguiente: Etiquetas >"
...
4.2.30\. Click "Siguiente: Revisar y crear >"
...
4.2.31\. Click "Descargar una plantilla para la automatización"
...
4.2.37\. Click "[miwebapp01.azurewebsites.net](http://miwebapp01.azurewebsites.net)"
...
#### 4.3 Crear un Pipeline de Release en Azure DevOps

4.3.1\. Navegar a [https://dev.azure.com/](https://dev.azure.com/azportal2024/Sample01)NOMBRE_DE_TU_ORGANIZACION


4.3.2\. Seleccionar el Proyecto deseado


4.3.3\. Click "Pipelines"
...
4.3.6\. Seleccionar template "Azure App Service Deployment" y click en "Apply"
...
4.3.7\. Cambiar el nombre de la etapa a "Deploy a QA"
...
4.3.9\. Agregar el artefacto a deployear, es el resultado del pipeline de build. Click en "Add"
...
4.3.10\. Seleccionamos el proyecto (por defecto el proyecto en el que estamos) y seleccionamos el pipeline del cual queremos sacar el artefacto a deployear. Click en "Expand"
...
4.3.11\. Click en el nombre de nuestro pipeline
...
4.3.13\. Habilitamos Continuous Deployment, cada vez que el pipeline de build se ejecute exitosamente, se disparará este pipeline de release.
...
4.3.14\. Habilitamos el toggle dejandolo **Habilitado**
...
4.3.15\. Configuramos las tareas del stage. Click "1 job, 1 task"
...
4.3.16\. Buscamos nuestra suscripción creada en Azure Portal. Click "Expand"
...
4.3.17\. Seleccionamos nuestra suscripción.
...
4.3.18\. Click "Authorize". Nos pedirá nuestros datos de la cuenta de Azure Portal
...
4.3.19\. Ingresamos nuestra cuenta de Azure Portal y hacemos click en "Siguiente"
...
4.3.21\. Una vez recibido el código en nuestro mail, lo ingresamos y clickeamos en "Sign in"
...
4.3.22\. Expandimos el combo para ver las opciones disponibles y dejamos seleccionada "Web App on Windows"
...
4.3.23\. Expandimos el combo de App service Name y seleccionamos nuestra Web App creada en Azure Portal
...
4.3.28\. Seleccionamos nuestro pipeline de Release
...
#### 4.4 Clonar una Web App a partir de un Template Deployment en Azure Portal

4.4.1\. Navigate to [https://portal.azure.com/#home](https://portal.azure.com/#home)


4.4.2\. Click en el Grupo de Recursos
...
4.4.4\. Buscar el recurso "Template Deployment (implementar mediante plantillas personalizadas)" y seleccionarlo
...
4.4.6\. Click "Cree su propia plantilla en el editor."
...
4.4.7\. Descomprimir el archivo template.zip que se descargó en los pasos 31 y 32 del instructivo "**Crear una Web App en Azure Portal"**
...
4.4.8\. Cargamos el archivo template.json que se extrajo del archivo template.zip que se descargó en los pasos 31 y 32 del instructivo "**Crear una Web App en Azure Portal"**
...
4.4.10\. Click "Editar parámetros"
...
4.4.11\. Cargamos el archivo parameters.json que se extrajo del archivo template.zip que se descargó en los pasos 31 y 32 del instructivo "**Crear una Web App en Azure Portal"**
...
4.4.13\. Click "Editar parámetros"
...
4.4.14\. Cambiamos el nombre de nuestra Web App agregandole el sufijo "-PROD"
...
4.4.19\. Click "Ir al grupo de recursos"
...
4.4.20\. Actualizamos el Grupo de Recursos
...
4.4.21\. Vemos que hemos clonado la WebApp correctamente:
